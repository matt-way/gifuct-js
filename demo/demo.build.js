...
url.value = '/demo/horses.gif'; // load the default gif
...
function loadGIF() {
  ...
  oReq.onload = function (oEvent) {
    ...
    if (arrayBuffer) {
      ...
      var frames = (0, _src.decompressFrames)(gif, true);
      console.log(gif); // render the gif
...
function renderFrame() {
  ...
  gifCtx.clearRect(0, 0, c.width, c.height); // draw the patch
