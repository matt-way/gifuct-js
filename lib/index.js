...
var decompressFrame = function decompressFrame(frame, gct, backgroundColorIndex, buildImagePatch) {
  if (!frame.image) {
...
var decompressFrames = function decompressFrames(parsedGif, buildImagePatches) {
  return parsedGif.frames.filter(function (f) {
    ...
    return decompressFrame(f, parsedGif.gct, parsedGif.lsd.backgroundColorIndex, buildImagePatches);
  });
};
